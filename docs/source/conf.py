# -*- coding: utf-8 -*-
#
# pygitrepo documentation build configuration file, created by
...
version = pygitrepo.__version__
# The full version, including alpha/beta/rc tags.
release = pygitrepo.__version__
...
htmlhelp_basename = 'pygitrepodoc'
...
man_pages = [
    (master_doc, 'pygitrepo', 'pygitrepo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pygitrepo', 'pygitrepo Documentation',
     author, 'pygitrepo', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from pygitrepo.docs import doc_data
except:
    doc_data = dict()
...
package_name = pygitrepo.__name__
